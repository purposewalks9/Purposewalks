      ...
      <Fade direction="up" delay={200} duration={1200} triggerOnce>
        <div className={`w-full flex flex-row justify-between pb-4 border-b-[1px] ${darkMode ? 'border-gray-700' : 'border-gray-300'} items-center gap-6 gap-x-8 md:gap-x-20 lg:gap-x-100`}>
          <div className="flex flex-col text-left gap-y-2">
            ...
            <p className={`text-xs sm:text-sm ${darkMode ? 'text-gray-400' : 'text-gray-700'}`}>Web dev , Design Engineer</p>
            <div className="flex flex-row gap-x-3 sm:gap-x-4 mt-2 sm:mt-2 text-sm items-center">
              ...
              <a href="https://github.com/purposewalks9" className="transition-transform hover:scale-110" style={{ color: darkMode ? '#ffffff' : '#181717' }}>
                <Github size={18} className="sm:w-5 sm:h-5" strokeWidth={1.5} />
              </a>
              <a href="https://x.com/purpose_walker" className="transition-transform hover:scale-110" style={{ color: darkMode ? '#ffffff' : '#181717' }}>
          ...
          <div className='relative'>
            <button
              onClick={() => copyToClipboard(window.location.href, 'www.purposewalker.name.ng')}
