  ...
  return (
    <div className="max-w-2xl p-8 md:p-12 lg:p-20 relative text-left overflow-hidden mx-auto min-h-screen flex flex-col justify-center items-start gap-y-8">
      <Fade direction="up" delay={200} duration={1200} triggerOnce>
        <div className="w-full flex flex-row justify-between items-start pb-4 gap-x-8">
          <div className="flex flex-col text-left w-full gap-y-2">
            <h1 className="text-2xl font-extrabold leading-tight tracking-tight">
              Purpose Walker
            </h1>
            <p
              className={`text-sm sm:text-base font-medium w-full ${
          ...
          <div className="relative flex flex-row gap-2 justify-center items-center shrink-0">
            <div className="flex flex-row gap-x-3 sm:gap-x-4 text-sm items-center">
              <a
                href="https://discord.com/users/purpos_e"
              ...
              <a
                href="https://github.com/purposewalks9"
                className="transition-transform hover:scale-110"
                style={{ color: darkMode ? "#ffffff" : "#181717" }}
              >
                <svg width="18" height="18" className="sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <Fade direction="up" delay={350} duration={1200} triggerOnce>
        <div className="flex flex-col gap-y-5">
          <p
            className={`text-base sm:text-lg leading-loose tracking-wide ${
              darkMode ? "text-gray-400" : "text-gray-700"
            }`}
          >
            I&apos;m a <span className={`font-bold ${darkMode ? "text-white" : "text-black"}`}>builder</span> who
            cares deeply about{" "}
            <span className={`font-bold ${darkMode ? "text-white" : "text-black"}`}>craft, systems</span>, and the{" "}
            <span className="italic font-medium" style={{ color: "#EA6D00", fontFamily: "cursive" }}>
              little details
            </span>{" "}
            that make software feel <span className={`font-bold ${darkMode ? "text-white" : "text-black"}`}>right</span>.
            <br />
            I&apos;m building{" "}
            <a
            ...
            , and I spend most of my time blending engineering, design and experimentation to make the{" "}
            <a 
              href="#" 
              className="underline font-medium transition-colors hover:opacity-80"
              style={{ color: "#EA6D00" }}
          ...
          <div className="flex flex-row gap-3">
            ...
            <button
              onClick={() => copyToClipboard("your@email.com", "email")}
              className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all hover:scale-105 hover:shadow-lg"
              style={{ 
                backgroundColor: darkMode ? "#2a2a2a" : "#e5e5e5",
